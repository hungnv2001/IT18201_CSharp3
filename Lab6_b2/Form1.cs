...
namespace Lab6_b2
{
    public partial class Form1 : Form
    {
        ...
        private List<BookManerger> GetData()
        {
            ...
            {
                bm.Database.CreateIfNotExists();
                dtgv_book.DataSource= bm.Catagolies.ToList();                                       
                cm_catagory.DisplayMember = "CatagolyName";
                cm_catagory.ValueMember = "CatagolyID";
                cm_catagory.DataSource= bm.Catagolies;
        ...
        private void dtgv_book_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            { 
                ...
                tx_price.Text = dtgv_book.SelectedCells[2].Value.ToString();
                tx_amount.Text = dtgv_book.SelectedCells[3].Value.ToString();
            }
            else
            {     
                Clear();
